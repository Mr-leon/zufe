package org.smartjq.mvc.admin.sys.generator;
...
public class DoGenerator {
    ...
    protected String packageBase     = "org.smartjq.mvc.admin";
...
//    protected String sourceFolder    = "/WebRoot";
    ...
    protected String packagePrefixes = "Ec";//生成model的时候去掉的ClassName前缀
    ...
    public void generatorModel(String tableName){
    	String pkgBase = "org.smartjq.mvc.common";
		...
		generator.addExcludedTable("dj_notice");
		generator.addExcludedTable("dj_notice_user");
