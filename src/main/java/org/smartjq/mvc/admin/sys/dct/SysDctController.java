...
public class SysDctController extends BaseController {
    ...
    public void listCostType() {
    	List<Record> list = service.listCostType();
    	renderJson(list);
    
    }
    
    public void listHonorType() {
    	List<Record> list = service.listHonorType();
    	renderJson(list);
    
    }
    
    public void listDctByTypeId() {
    	String typeId = getPara("typeId");
    	List<Record> list = service.listByTypeId(typeId);
    	renderJson(list);
    }
