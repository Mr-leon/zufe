package org.smartjq.mvc.admin.sys.dct;
...
import org.smartjq.mvc.common.model.SysDct;
import org.smartjq.mvc.common.model.SysDctGroup;
...
public class SysDctService{
	...
	public List<Record> listCostType() {
		String sql  = "select o.name, o.value from sys_dct o where o.type ='cost_type' order by o.name ";
		return Db.find(sql);
	}

	public List<Record> listHonorType() {
		String sql  = "select o.name, o.value from sys_dct o where o.type ='honor_type' order by o.name ";
		return Db.find(sql);
	}

	public List<Record> listByTypeId(String typeId) {
		String sql  = "select o.name, o.value from sys_dct o where o.type ='" + typeId + "' order by o.name ";
		return Db.find(sql);
	}
