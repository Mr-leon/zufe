package org.smartjq.mvc.admin.sys.cms;
...
import org.smartjq.mvc.common.model.CmsContent;
...
public class CmsService {
	...
	public List<CmsContent> getMyNotice(String userid){
		return dao.find("select DISTINCT n.*,u.if_sign from oa_notice n ,oa_notice_user u where n.id=u.notice_id and u.user_id='"+userid+"' and n.if_publish='1'");
	}
}
