...
public class DateUtil {
	...
	public static String getTime() {
		return new SimpleDateFormat(dateFormat[8]).format(new Date());
	}
	...
	/**
	 * 作者：zy 日期：2011-9-8 方法描述： 将日期格式从 java.util.Calendar 转到 java.sql.Timestamp 格式
	 * 
	 * @param date 格式表示的日期
	 * @return 使用说明：
	 *
	...
	/**
	 * @Title: getStartDate @Description: 获取当前日期，"yyyy-MM-dd
	 * 05:00:00" @param @return 设定文件 @return String 返回类型 @throws
	 */
	public static String getStartDate() {
		String startTime = new SimpleDateFormat(dateFormat[3]).format(new Date());
		startTime = startTime + " 05:00:00";
		return startTime;
	}

	/**
	 * @Title: getDate @Description: 获取当前日期，"yyyy-MM-dd" @param @return 设定文件 @return
	 * String 返回类型 @throws
	 */
	...
	/**
	 * @Title: getDateTime @Description: 获取当前日期，"yyyy-MM-dd
	 * HH:mm:ss:SSS" @param @return 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 作者：zy 方法描述： 返回固定格式的日期字符串。转换结果格式为："yyyy-MM-dd"
	 *
	 ...
	 * @return String 为null时转换失败 倒计时够天数显示天数，不够显示小时，不够小时显示分钟 2天后面没有1天，而是24小时，2小时同理
	 */
	 ...
	 * @throws ParseException
	 */
	public static String getStartLastMounth(String dateStr) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date date = sdf.parse(dateStr);
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	...
	public static void main(String[] args) throws Exception {
		// Integer i =
		// DateUtil.getDiffNum(DateUtil.StringToDate("2017-01",16),DateUtil.StringToDate("2018-12",16));
